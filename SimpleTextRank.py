...
class SimpleTextRank(object):
    def __init__(self, window, file, file_data, data):
        """
    ...
    def execute(self):
        ...
        for id_suggestion, suggestion in self.data.items():
            ...
            if id_suggestion != '-1':
                ...
                results = MysqlND.execute_query(query, (id_suggestion, self.file_data,))
                ...
                if result[0] is None:
                    ...
                    MysqlND.execute_query(update, (self.texts_tagged[id_suggestion], id_suggestion, self.file_data,))
    ...
    def calcula_tags(self, text):
        ...
        tags = nlp.pos_tag(text.encode('utf-8').strip())
        nlp.close()
    ...
    def elimina_tildes(s):
        s = s.encode('utf-8').strip().decode('utf-8')
